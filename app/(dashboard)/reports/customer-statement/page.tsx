...
export default function CustomerStatementPage() {
  ...
  return (
    <ReportsLayout title="كشف حساب عميل" subtitle="فواتير، مدفوعات، ورصيد العميل خلال فترة محددة">
      <ReportShell
      ...
      >
        {!customerId ? (
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-12 text-center text-slate-500">
            اختر عميلاً لاستعراض كشف حسابه
          </div>
        ) : data && (
          <>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
              ...
              {data.transactions.length === 0 ? (
                <div className="p-8 text-center text-slate-400 text-sm">لا توجد حركات في هذه الفترة</div>
              ) : (
