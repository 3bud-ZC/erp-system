...
export default function PurchaseInvoicesPage() {
  ...
  const columns = [
    ...
    { key: 'supplier', label: 'المورد', render: (val: any) => val?.nameAr || '-' },
    ...
    <div className="space-y-8">
      <div className="relative">
        ...
        <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-4xl font-bold gradient-text mb-3">فواتير الشراء</h1>
            <p className="text-gray-600/80 text-lg">إدارة فواتير الشراء</p>
          </div>
          <div className="flex gap-3">
            ...
            >
              <span className="font-medium">الموردين</span>
            </Link>
            <Link
